...
class AdvancePaymentHome(http.Controller):
    """Controller for managing advance payment."""
    ...
    def create_advance_payment_json(self):
        """Create a new advance payment on the system."""
        invalid_fields = []
    ...
    @validate_token
    @http.route(
        "/fb_api/get-advance-payments/json",
        auth="public",
        type="json",
        csrf=False,
        cors="*",
    ...
    def get_payments_json(self):
        ...
        domain = [
            ...
            ("is_advance", "=", True),
            ("company_id", "=", get_eservice_default_company(request._cr)),
        ]
