...
class TestProcessingFlows(MonnifyCommon, PaymentHttpCommon):

    @mute_logger('odoo.addons.payment_monnify.controllers.main')
    def test_redirect_notification_triggers_processing(self):
        ...
        url = self._build_url(MonnifyController._return_url)
        with patch(
    ...
    def test_webhook_notification_triggers_processing(self):
        ...
        url = self._build_url(MonnifyController._webhook_url)
        with patch(
            'odoo.addons.payment_monnify.controllers.main.MonnifyController.'
    ...
    def test_accept_webhook_notification_with_valid_signature(self):
        ...
        self._assert_does_not_raise(
            Forbidden,
            MonnifyController._verify_notification_signature,
            self.provider.monnify_webhook_secret,
            tx,
        )
    ...
    def test_reject_notification_with_missing_signature(self):
        ...
        tx = self._create_transaction('redirect')
        self.assertRaises(Forbidden, MonnifyController._verify_notification_signature, None, tx)
    ...
    def test_reject_notification_with_invalid_signature(self):
        ...
        tx = self._create_transaction('redirect')
        self.assertRaises(
            Forbidden, MonnifyController._verify_notification_signature, 'dummy', tx
        )
